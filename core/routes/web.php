...
Route::get('/ajax-oyuncu-istatistik', [HomeController::class, 'oyuncu_istatistik_ajax'])->name('ajax-oyuncu-istatistik');

Route::post('/ajax-oyuncular', [HomeController::class, 'oyuncular_ajax'])->name('ajax-oyuncular');
Route::post('/ajax-oyuncu-listeler', [HomeController::class, 'oyuncu_listeler_ajax'])->name('ajax-oyuncu-listeler');
Route::post('/ajax-oyuncular/{takim}/{value1}/{sezon}/{value2}/{donem}/{value3}', [HomeController::class, 'oyuncular_ajax']);
Route::post('/ajax-sezonlar', [HomeController::class, 'sezonlar_ajax'])->name('ajax-sezonlar');
Route::post('/ajax-takimlar', [HomeController::class, 'takimlar_ajax'])->name('ajax-takimlar');
Route::post('/ajax-pozisyonlar', [HomeController::class, 'pozisyonlar_ajax'])->name('ajax-pozisyonlar');
Route::post('/ajax-kapsamlar', [HomeController::class, 'kapsamlar_ajax'])->name('ajax-kapsamlar');
Route::post('/ajax-ligler', [HomeController::class, 'ligler_ajax'])->name('ajax-ligler');
Route::post('/ajax-oyuncular-istatistik', [HomeController::class, 'oyuncular_istatistik_ajax'])->name('ajax-oyuncular-istatistik');
Route::post('/ajax-oyuncu-istatistik/{takim}/{value1}/{sezon}/{value2}/{donem}/{value3}', [HomeController::class, 'oyuncular_istatistik_ajax']);

Route::get('/ajax-donem-istatistik', [HomeController::class, 'donem_istatistik_ajax'])->name('ajax-donem-istatistik');
Route::post('/ajax-donem-istatistik-donemler', [HomeController::class, 'donem_istatistik_ajax_donemler'])->name('ajax-donem-istatistik-donemler');

Route::get('/ajax-pozisyon-istatistik', [HomeController::class, 'pozisyon_istatistik_ajax'])->name('ajax-pozisyon-istatistik');
Route::post('/ajax-pozisyon-istatistik-pozisyonlar', [HomeController::class, 'pozisyon_istatistik_ajax_pozisyonlar'])->name('ajax-pozisyon-istatistik-pozisyonlar');

Route::get('/ajax-tbl-mac-sonuclari', [HomeController::class, 'tbl_mac_sonuclari_ajax'])->name('ajax-tbl-mac-sonuclari');
Route::get('/ajax-bsl-mac-sonuclari', [HomeController::class, 'bsl_mac_sonuclari_ajax'])->name('ajax-bsl-mac-sonuclari');

Route::get('/ajax-mac-analizleri', [HomeController::class, 'mac_analizleri_ajax'])->name('ajax-mac-analizleri');
Route::post('/ajax-mac-analizleri-filtreler', [HomeController::class, 'mac_analizleri_filtreler_ajax'])->name('ajax-mac-analizleri-filtreler');

Route::get('/ajax-oyuncu-profil-tablosu', [HomeController::class, 'oyuncu_profil_tablosu_ajax'])->name('ajax-oyuncu-profil-tablosu');
...
Route::post('/admin/excel-contacts', [HomeController::class, 'excelContact']);
Route::get('/admin/excel-contacts-clear', [HomeController::class, 'excelContactsClear']);
