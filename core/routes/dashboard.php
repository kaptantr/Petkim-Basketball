...
use App\Http\Controllers\Dashboard\IstatistikController;
use App\Http\Controllers\Dashboard\LigController;
use App\Http\Controllers\Dashboard\MenusController;
use App\Http\Controllers\Dashboard\SettingsController;
use App\Http\Controllers\Dashboard\SezonController;
use App\Http\Controllers\Dashboard\TakimController;
...
Route::get('/webmaster/banners/destroy/{id}',    [WebmasterBannersController::class, 'destroy'])->name('WebmasterBannersDestroy');
Route::post('/webmaster/banners/updateAll',    [WebmasterBannersController::class, 'updateAll'])->name('WebmasterBannersUpdateAll');
...
Route::post('/webmaster/sections/{id}/update',    [WebmasterSectionsController::class, 'update'])->name('WebmasterSectionsUpdate');

Route::post('/webmaster/sections/{id}/seo', [WebmasterSectionsController::class, 'seo'])->name('WebmasterSectionsSEOUpdate');

Route::get('/webmaster/sections/destroy/{id}',    [WebmasterSectionsController::class, 'destroy'])->name('WebmasterSectionsDestroy');
Route::post('/webmaster/sections/updateAll',    [WebmasterSectionsController::class, 'updateAll'])->name('WebmasterSectionsUpdateAll');
...
// Istatistik
Route::post('/istatistik-list', [IstatistikController::class, 'list'])->name('istatistiksList');
Route::get('/istatistik/{id}/edit', [IstatistikController::class, 'index'])->name('istatistikEdit');

// Sezons
Route::get('/sezons/{oyuncu_id?}', [SezonController::class, 'index'])->name('sezons');
Route::post('/sezons/store', [SezonController::class, 'store'])->name('sezonsStore');
Route::post('/sezons/search', [SezonController::class, 'search'])->name('sezonsSearch');
Route::get('/sezons/{id}/edit', [SezonController::class, 'edit'])->name('sezonsEdit');
Route::post('/sezons/{id}/update', [SezonController::class, 'update'])->name('sezonsUpdate');
Route::get('/sezons/destroy/{id}', [SezonController::class, 'destroy'])->name('sezonsDestroy');

// Ligs
Route::get('/ligs/{oyuncu_id?}', [LigController::class, 'index'])->name('ligs');
Route::post('/ligs/store', [LigController::class, 'store'])->name('ligsStore');
Route::post('/ligs/search', [LigController::class, 'search'])->name('ligsSearch');
Route::get('/ligs/{id}/edit', [LigController::class, 'edit'])->name('ligsEdit');
Route::post('/ligs/{id}/update', [LigController::class, 'update'])->name('ligsUpdate');
Route::get('/ligs/destroy/{id}', [LigController::class, 'destroy'])->name('ligsDestroy');

// Takıms
Route::get('/takims/{oyuncu_id?}', [TakimController::class, 'index'])->name('takims');
Route::post('/takims/store', [TakimController::class, 'store'])->name('takimsStore');
Route::post('/takims/search', [TakimController::class, 'search'])->name('takimsSearch');
Route::get('/takims/{id}/edit', [TakimController::class, 'edit'])->name('takimsEdit');
Route::post('/takims/{id}/update', [TakimController::class, 'update'])->name('takimsUpdate');
Route::get('/takims/destroy/{id}', [TakimController::class, 'destroy'])->name('takimsDestroy');
...
Route::get('/{webmasterId}/topics/{id}/photos/{photo_id}/destroy', [TopicsController::class, 'photosDestroy'])->name('topicsPhotosDestroy');
Route::post('/{webmasterId}/topics/{id}/photos/updateAll', [TopicsController::class, 'photosUpdateAll'])->name('topicsPhotosUpdateAll');

// Topics :Files
Route::get('/{webmasterId}/topics/{id}/files', [TopicsController::class, 'topicsFiles'])->name('topicsFiles');
Route::get('/{webmasterId}/topics/{id}/files/create', [TopicsController::class, 'filesCreate'])->name('topicsFilesCreate');
Route::post('/{webmasterId}/topics/{id}/files/store', [TopicsController::class, 'filesStore'])->name('topicsFilesStore');
Route::get('/{webmasterId}/topics/{id}/files/{file_id}/edit', [TopicsController::class, 'filesEdit'])->name('topicsFilesEdit');
Route::post('/{webmasterId}/topics/{id}/files/{file_id}/update', [TopicsController::class, 'filesUpdate'])->name('topicsFilesUpdate');
Route::get('/{webmasterId}/topics/{id}/files/destroy/{file_id}', [TopicsController::class, 'filesDestroy'])->name('topicsFilesDestroy');
Route::post('/{webmasterId}/topics/{id}/files/updateAll', [TopicsController::class, 'filesUpdateAll'])->name('topicsFilesUpdateAll');
...
Route::get('/{webmasterId}/topics/{id}/related/create', [TopicsController::class, 'relatedCreate'])->name('topicsRelatedCreate');
Route::post('/{webmasterId}/topics/{id}/related/store', [TopicsController::class, 'relatedStore'])->name('topicsRelatedStore');
Route::get('/{webmasterId}/topics/{id}/related/destroy/{related_id}', [TopicsController::class, 'relatedDestroy'])->name('topicsRelatedDestroy');
Route::post('/{webmasterId}/topics/{id}/related/updateAll', [TopicsController::class, 'relatedUpdateAll'])->name('topicsRelatedUpdateAll');
// Topics :Comments
Route::get('/{webmasterId}/topics/{id}/comments', [TopicsController::class, 'topicsComments'])->name('topicsComments');
Route::get('/{webmasterId}/topics/{id}/comments/create', [TopicsController::class, 'commentsCreate'])->name('topicsCommentsCreate');
Route::post('/{webmasterId}/topics/{id}/comments/store', [TopicsController::class, 'commentsStore'])->name('topicsCommentsStore');
Route::get('/{webmasterId}/topics/{id}/comments/{comment_id}/edit', [TopicsController::class, 'commentsEdit'])->name('topicsCommentsEdit');
Route::post('/{webmasterId}/topics/{id}/comments/{comment_id}/update', [TopicsController::class, 'commentsUpdate'])->name('topicsCommentsUpdate');
Route::get('/{webmasterId}/topics/{id}/comments/destroy/{comment_id}', [TopicsController::class, 'commentsDestroy'])->name('topicsCommentsDestroy');
Route::post('/{webmasterId}/topics/{id}/comments/updateAll', [TopicsController::class, 'commentsUpdateAll'])->name('topicsCommentsUpdateAll');
// Topics :Maps
...
Route::post('/{webmasterId}/topics/{id}/maps/{map_id}/update', [TopicsController::class, 'mapsUpdate'])->name('topicsMapsUpdate');
Route::get('/{webmasterId}/topics/{id}/maps/destroy/{map_id}', [TopicsController::class, 'mapsDestroy'])->name('topicsMapsDestroy');
Route::post('/{webmasterId}/topics/{id}/maps/updateAll', [TopicsController::class, 'mapsUpdateAll'])->name('topicsMapsUpdateAll');
...
// Contacts
Route::get('/contacts/{oyuncu_id?}', [ContactsController::class, 'index'])->name('contacts');
