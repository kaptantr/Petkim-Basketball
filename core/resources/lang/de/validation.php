...
return [
    ...
    */
    ...
    'date_equals' => 'Das Attribut: muss ein Datum sein, das gleich ist: date.',
    ...
    'digits' => 'Das Attribut: muss sein: digits digits.',
    'digits_between' => 'Das Attribut: muss zwischen: min und: max liegen.',
    ...
    'gt' => [
        'numeric' => 'Das Attribut: muss größer sein als: value.',
    ...
    'gte' => [
        ...
        'string' => 'Das Attribut: muss größer oder gleich: value-Zeichen sein.',
        'array' => 'Das Attribut: muss mindestens Folgendes enthalten: Wertelemente oder mehr.',
    ],
    ...
    'required_if' => 'Das Feld: attribute ist erforderlich, wenn: other is: value.',
    ...
    'required_without_all' => 'Das Feld: attribute ist erforderlich, wenn keiner der folgenden Werte vorhanden ist.',
    'same' => 'Das Attribut: und: other müssen übereinstimmen.',
    'size' => [
        'numeric' => 'Das Attribut: muss sein: size.',
