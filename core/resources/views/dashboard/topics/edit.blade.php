    ...
    <div class="padding">
        <div class="box m-b-0">
            <div class="box-header dker">
                ...
                ?>
                <h3><i class="material-icons"> &#xe3c9;</i> {{ __('backend.topicEdit') }} {!! $WebmasterSectionTitle !!}
                </h3>
                <small>
        ...
        <div class="box nav-active-border b-info">
            <ul class="nav nav-md">
                ...
                @if($WebmasterSection->multi_images_status)
                    ...
                    <span class="text-md"><i class="material-icons"> &#xe251;</i>
                ...
                @if($WebmasterSection->extra_attach_file_status)
                    ...
                    <span class="text-md"><i class="material-icons"> &#xe226;</i> {{ __('backend.additionalFiles') }}
                ...
                @if($WebmasterSection->comments_status)
                    ...
                    <span class="text-md"><i class="material-icons"> &#xe0b9;</i> {{ __('backend.comments') }}
                ...
                @if(Helper::GeneralWebmasterSettings("seo_status"))
                    ...
                    <span class="text-md"><i class="material-icons"> &#xe8e5;</i> {{ __('backend.seoTabTitle') }}</span>
                        </a>
                    </li>
                @endif
