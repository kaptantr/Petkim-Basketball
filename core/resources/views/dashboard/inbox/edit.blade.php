        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <div id="cc" style="<?php echo $cc;?>" class="form-group row">
                    ...
                    <div class="col-sm-1">
                        <a onclick="document.getElementById('to_cc').value='';document.getElementById('cc').style.display='none'"><i class="material-icons md-18">×</i></a>
                    </div>
                </div>
                <div id="bcc" style="<?php echo $bcc;?>" class="form-group row">
                    ...
                    <div class="col-sm-1">
                        <a onclick="document.getElementById('to_bcc').value='';document.getElementById('bcc').style.display='none'"><i class="material-icons md-18">×</i></a>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="title_en"
                ...
                <div class="form-group row m-t-md">
                    <div class="offset-sm-2 col-sm-10">
                        ...
                        <button type="submit" name="btn_send" onclick="document.getElementById('btn_clicked').value=''"  class="btn btn-primary m-t"><i class="material-icons">
                                &#xe31b;</i> {!! __('backend.send') !!}</button>
                        <button type="submit" name="btn_draft" onclick="document.getElementById('btn_clicked').value='draft'" class="btn btn-default m-t"><i class="material-icons">
