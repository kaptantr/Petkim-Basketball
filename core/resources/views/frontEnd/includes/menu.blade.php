                    ...
                    @if($HeaderMenuLink->type==3)
                        ...
                        <li class="dropdown">
                            <a href="javascript:void(0)" class="dropdown-toggle " data-toggle="dropdown" data-hover="dropdown"
                               data-delay="0" data-close-others="true">{{ $link_title }} <i class="fa fa-angle-down"></i></a>
                                    ...
                                    @foreach($HeaderMenuLink->subMenus as $subMenu)
                                        ...
                                        @if($subMenu->type==3)
                                            ...
                                            <li><a href="javascript:void(0)" class="dropdown-toggle "
                                                ...
                                                @if(!empty($subMenu->webmasterSection->sections) && count($subMenu->webmasterSection->sections) >0)
                                                    {{--categories drop down--}}
                                                    <ul class="dropdown-menu">
                                                ...
                                                @elseif(!empty($subMenu->webmasterSection->topics) && count($subMenu->webmasterSection->topics) >0)
                                                    {{--topics drop down--}}
                                                    <ul class="dropdown-menu">
                                        ...
                                        @elseif($subMenu->type==2)
                                            ...
                                            ?>
                                            <li>
                                                <a href="{{ $subMenu->link }}">{{ $subMenu_title }}</a>
                                            </li>
