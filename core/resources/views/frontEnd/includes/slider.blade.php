            ...
            <div id="main-slider" class="flexslider">
                <ul class="slides">
                    @foreach($SliderBanners as $SliderBanner)
                        ...
                        ?>
                            <li>
                                @if($SliderBanner->video_type == '100')
                                    <img class="vidyard-player-embed" src="{{ $SliderBanner->code }}"
                                         data-uuid="<?php preg_match('/\.com\/(.*)\.jpg/', $SliderBanner->code, $array); echo $array[1] ?? ''; ?>"
